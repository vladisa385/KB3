...
for line in f:
 text +=line
res = explode(10, text) #We consider in this exemple a key length of 10 and l the original list
for i in range(1,10+1): #For each sub-list
    occ = countOcc(res[i]) #Make a frequency analysis
    shift = (int(occ[0][0]) - 32) % 256 # Consider the most frequent element of being a space(32 in decimal)
